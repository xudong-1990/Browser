package com.beiyang.xudong.browsers;
        ...
        import com.beiyang.xudong.other.FavAndHisManager;
        import com.beiyang.xudong.other.ToolsPopWindow;

public class Browsers extends AppCompatActivity {
...
/*
    ...
    private class OwnerWebView extends WebViewClient{
        ...
        public void onReceivedError(WebView view, int errorCode,
            ...
            if(errorCode==WebViewClient.ERROR_HOST_LOOKUP){
                ...
                new AlertDialog.Builder(Browsers.this)
                        .setTitle("警告")
    ...
    private class OwnerChromeClient extends WebChromeClient{
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            ...
            //Browsers.this.setProgress(newProgress * 100);
            if(newProgress==100){
    ...
    private class ButtonClickedListener implements OnClickListener{
        ...
        public void onClick(View v) {
            if(v.getId()==R.id.web_url_goto){
                ...
                imm.hideSoftInputFromWindow(webHolder.getWindowToken(), 0);
                ...
                startActivityForResult(new Intent(Browsers.this,FavAndHisActivity.class),0);
            }
        }
